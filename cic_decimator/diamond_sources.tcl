...
prj_src add $abs_path/hdl/cic_decim_comb.sv
prj_src add $abs_path/hdl/cic_decim_compfir.sv
prj_src add $abs_path/hdl/cic_decim_integrator.sv
prj_src add $abs_path/hdl/cic_decim_stages.sv
prj_src add $abs_path/hdl/cic_decimator.sv