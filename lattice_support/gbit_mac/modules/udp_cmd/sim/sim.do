...
vlog ../../../../fifos/pmi_fifo_sc_fwft_v1_0/hdl/pmi_fifo_sc_fwft_v1_0.sv
vlog ../../../../fifos/pmi_fifo_dc_fwft_v1_0/hdl/pmi_fifo_dc_fwft_v1_0.sv
vlog ../../../../../interfaces/cmd_interface/hdl/intf_cmd.sv
vlog ../../../../../interfaces/cmd_interface/hdl/cmd_slave_example.sv
vlog -incdir ../../../packages -work work ../../udp_packetizer/hdl/*.sv
...
vsim -log sim.log +access +r -lib work -L pmi_work tb_udp_cmd
...
trace -decl *
trace -decl DUT/*
trace -decl cmd_slave*/*
#trace -decl DUT/UDP_PACKETIZER_CMD/*
