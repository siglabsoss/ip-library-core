...
prj_src add $abs_path/hdl/duc_fixed_dds.sv
prj_src add $abs_path/hdl/duc_hb_cascade.sv
prj_src add $abs_path/hdl/duc_hb_interp_fir_h0.sv
prj_src add $abs_path/hdl/duc_skid.sv
prj_src add $abs_path/hdl/upconverter.sv
prj_src add $abs_path/hdl/var_freq_upconverter.sv
