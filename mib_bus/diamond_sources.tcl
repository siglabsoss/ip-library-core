...
prj_src add $abs_path/hdl/mib_master.sv
prj_src add $abs_path/hdl/mib_slave.sv
prj_src add $abs_path/hdl/mib_master_wrapper.sv
prj_src add $abs_path/hdl/mib_slave_wrapper.sv