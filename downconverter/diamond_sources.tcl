...
prj_src add $abs_path/hdl/fixed_ddsx2.sv
prj_src add $abs_path/hdl/ddc_hb_cascade.sv
prj_src add $abs_path/hdl/ddc_hb_decim_fir_h1.sv
prj_src add $abs_path/hdl/ddc_hb_decim_fir_h2.sv
prj_src add $abs_path/hdl/ddc_hb_decim_firx2_h0.sv
prj_src add $abs_path/hdl/downconverter.sv

append syn_cmd_line_args "set_option -include_path $abs_path/hdl;"
